import { f as F, j as e, S as we, c as _, u as ie, a as X, b as E, d as H, e as ne, g as x, h as S, i as q, R as ye, k as ee, l as se, m as ke, n as L, o as _e, p as D, s as G, A as Ce } from "./index-B1MLE706.mjs";
import { B as A, X as ze, H as le, C as Ae, L as Me, a as V, b as I, c as B, d as O, e as U, S as y, f as Te, P as Le, g as Ee, G as R, U as oe, M as P, h as $e, E as Z, F as ce, i as We, j as De, k as Y, l as Re, m as J, K as Fe, n as He, o as Ve, p as Ie, I as Be, q as Oe, r as ae, s as te, t as Ue, u as Ge, v as Ye, w as Ke, x as Qe, y as qe, z as Pe, N as Je, D as Xe, A as Ze, J as Se } from "./stats-D3Sgo-rN.mjs";
import { R as es, T as ss, P as as, C as de, a as me, D as ue, O as he, g as xe, b as ts } from "./audience-MBuIJMEB.mjs";
import { u as rs } from "./use-growth-stats-DMmcGk36.mjs";
function is(s) {
...
const ds = es, ms = ss, us = as, ge = F(({ className: s, ...t }, a) => /* @__PURE__ */ e.jsx(
  he,
  {
    ref: a,
    className: _(
...
const fe = F(({ className: s, children: t, ...a }, i) => /* @__PURE__ */ e.jsx(us, { children: /* @__PURE__ */ e.jsxs("div", { className: we, children: [
  /* @__PURE__ */ e.jsx(ge, {}),
  /* @__PURE__ */ e.jsx(
    de,
    {
...
const hs = ({
  ...
  return /* @__PURE__ */ e.jsxs(ds, { ...f, children: [
    /* @__PURE__ */ e.jsx(ms, { className: "cursor-pointer", asChild: !0, children: N }),
    /* @__PURE__ */ e.jsxs(fe, { className: "max-h-[calc(100vh-16vmin)] max-w-[540px] overflow-y-auto p-8", children: [
      /* @__PURE__ */ e.jsx("div", { className: "sticky top-0 ml-auto size-0", children: /* @__PURE__ */ e.jsx(A, { className: "absolute -right-5 -top-5 cursor-pointer p-2 text-muted-foreground hover:text-foreground [&_svg]:!size-6", size: "lg", variant: "link", onClick: g, children: /* @__PURE__ */ e.jsx(ze, { size: 24, strokeWidth: 1 }) }) }),
      ...
      /* @__PURE__ */ e.jsx(je, { className: "justify-between gap-6", children: s ? /* @__PURE__ */ e.jsx(A, { className: "cursor-pointer", type: "submit", onClick: g, children: "Close" }) : /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
        /* @__PURE__ */ e.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ e.jsx("a", { className: "flex h-[34px] w-14 items-center justify-center rounded-sm bg-muted px-3 hover:bg-muted-foreground/20 [&_svg]:h-4", href: `https://threads.net/intent/post?text=${k}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ e.jsxs("svg", { fill: "none", viewBox: "0 0 18 18", children: [
          ...
          /* @__PURE__ */ e.jsx("a", { className: "flex h-[34px] w-14 items-center justify-center rounded-sm bg-muted px-3 hover:bg-muted-foreground/20 [&_svg]:h-4", href: `https://www.facebook.com/sharer/sharer.php?u=${b}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ e.jsxs("svg", { fill: "none", viewBox: "0 0 40 40", children: [
        ...
        /* @__PURE__ */ e.jsxs(
          A,
          {
            ...
            onClick: v,
            children: [
              r ? /* @__PURE__ */ e.jsx(Ae, {}) : /* @__PURE__ */ e.jsx(Me, {}),
              r ? "Copied!" : "Copy link"
            ]
          }
        )
...
}, xs = (s) => s.email_only ? "Sent" : s.email ? "Published and sent" : "Published", ps = ({
  latestPostStats: s,
  isLoading: t
}) => {
  var k, T, $, W;
  const a = X(), [i, n] = ie(!1), { site: l, settings: u } = E(), { appSettings: o } = H(), {
    emailTrackClicks: c,
    emailTrackOpens: p,
    webAnalytics: d = !1,
    membersTrackSources: g = !1
  } = (o == null ? void 0 : o.analytics) || {}, N = l.title || String(((k = u.find((C) => C.key === "title")) == null ? void 0 : k.value) || "Ghost Site"), f = String(((T = u.find((C) => C.key === "timezone")) == null ? void 0 : T.value) || "Etc/UTC"), r = s ? cs(s, {
  ...
  return /* @__PURE__ */ e.jsxs(V, { className: "group/card bg-gradient-to-tr from-muted/40 to-muted/0 to-50%", "data-testid": "latest-post", children: [
        ...
        /* @__PURE__ */ e.jsxs("div", { className: "flex flex-col gap-6 px-6 transition-all md:flex-row md:items-start xl:col-span-2", children: [
          ...
          /* @__PURE__ */ e.jsxs("div", { className: "flex grow flex-col items-start justify-center self-stretch", children: [
            ...
            /* @__PURE__ */ e.jsxs("div", { className: "mt-0.5 text-sm text-muted-foreground", children: [
              ...
              /* @__PURE__ */ e.jsx("div", { className: "mt-0.5", children: xs(s) })
            ] }),
        ...
        /* @__PURE__ */ e.jsx("div", { className: "-ml-4 flex w-full flex-col items-stretch gap-2 pr-6 text-sm xl:h-full xl:max-w-none", children: /* @__PURE__ */ e.jsxs("div", { className: "grid grid-cols-2 gap-6 pl-10 lg:border-l xl:h-full", children: [
          ...
          r.showEmailMetrics && s.email && /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
            p && /* @__PURE__ */ e.jsxs("div", { className: m, onClick: () => {
              ...
              /* @__PURE__ */ e.jsx("span", { className: "text-[2.2rem] font-semibold leading-none tracking-tighter", children: s.email.email_count ? S((s.email.opened_count || 0) / s.email.email_count) : "0%" })
            ] }),
            c && /* @__PURE__ */ e.jsxs("div", { className: m, onClick: () => {
              ...
              /* @__PURE__ */ e.jsx("span", { className: "text-[2.2rem] font-semibold leading-none tracking-tighter", children: s.email.email_count && ((W = s.count) != null && W.clicks) ? S((s.count.clicks || 0) / s.email.email_count) : "0%" })
            ] })
          ] })
        ] }) })
      ] }) : !t && /* @__PURE__ */ e.jsx(
  ...
  const { range: d } = E(), g = t && Ve[t], N = ye.useMemo(() => {
    if (!n || n === "empty" || d === ee.allTime.value || !l)
      return "";
    const f = n === "up" ? "up" : n === "down" ? "down" : "at", m = J(d).replace("in the ", "").replace(/^\(|\)$/g, "");
  ...
  return /* @__PURE__ */ e.jsxs(V, { className: "group", "data-testid": s, children: [
    /* @__PURE__ */ e.jsxs(I, { className: "hidden", children: [
  ...
  const c = X(), { range: p } = E(), { appSettings: d } = H(), N = gs().isLimited("limitAnalytics"), f = "-mb-3 h-[10vw] max-h-[200px] min-h-[100px] hover:!cursor-pointer";
  if (o)
    return /* @__PURE__ */ e.jsx(We, { className: "flex h-[calc(10vw+116px)] max-h-[416px] min-h-20 items-center justify-center hover:!cursor-pointer", children: /* @__PURE__ */ e.jsx(De, {}) });
  ...
  const T = `flex flex-col lg:grid ${k} gap-6`;
  ...
  var N, f;
  const a = X(), { range: i, settings: n } = E(), { appSettings: l } = H(), u = String(((N = n.find((r) => r.key === "timezone")) == null ? void 0 : N.value) || "Etc/UTC"), {
    webAnalytics: o = !1,
  ...
  return /* @__PURE__ */ e.jsxs(V, { className: "group/card w-full lg:col-span-2", "data-testid": "top-posts-card", children: [
    /* @__PURE__ */ e.jsxs(I, { children: [
    ...
    /* @__PURE__ */ e.jsx(U, { children: t ? /* @__PURE__ */ e.jsx(Oe, { className: "mt-6" }) : /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
      (f = s == null ? void 0 : s.stats) == null ? void 0 : f.map((r) => /* @__PURE__ */ e.jsxs("div", { className: 'group relative flex w-full items-start justify-between gap-5 border-t border-border/50 py-4 before:absolute before:-inset-x-4 before:inset-y-0 before:z-0 before:hidden before:rounded-md before:bg-accent before:opacity-80 before:content-[""] first:!border-border hover:cursor-pointer hover:border-transparent hover:before:block md:items-center dark:before:bg-accent/50 [&+div]:hover:border-transparent', children: [
        /* @__PURE__ */ e.jsxs("div", { className: "z-10 flex min-w-[160px] grow items-start gap-4 md:items-center lg:min-w-[320px]", onClick: () => {
          ...
          } }) : /* @__PURE__ */ e.jsx(bs, { className: "hidden aspect-[16/10] w-[80px] shrink-0 group-hover:bg-muted-foreground/10 sm:!visible sm:!flex lg:w-[100px]" }),
          /* @__PURE__ */ e.jsxs("div", { className: "flex flex-col", children: [
            ...
            /* @__PURE__ */ e.jsx("span", { className: "text-sm text-muted-foreground", children: is(r) })
          ] })
        ] }),
  ...
  const { appSettings: s } = H(), { statsConfig: t, isLoading: a, range: i } = E(), { startDate: n, endDate: l, timezone: u } = _e(i), { isLoading: o, chartData: c, totals: p, currencySymbol: d } = rs(i), { data: g, isLoading: N } = ws(), { data: f, isLoading: r } = Ke({
    searchParams: {
      date_from: D(n),
      date_to: D(l),
      limit: "5",
    ...
    return (j = G(v || [], i, "visits", "sum")) == null ? void 0 : j.map((z) => {
      const M = Number(z.visits), h = isNaN(M) ? 0 : M;
      return {
        date: String(z.date),
        value: h,
        formattedValue: x(h),
    ...
    if (!(v != null && v.length))
      return { visits: "0" };
    const j = v.reduce((z, M) => {
      const h = Number(M.visits);
  ...
  return /* @__PURE__ */ e.jsxs(qe, { children: [
    /* @__PURE__ */ e.jsx(Pe, { children: /* @__PURE__ */ e.jsx(Je, { children: /* @__PURE__ */ e.jsx(Xe, { excludeRanges: ["today"] }) }) }),
    /* @__PURE__ */ e.jsxs(Ze, { isLoading: C, loadingComponent: /* @__PURE__ */ e.jsx(e.Fragment, {}), children: [
      /* @__PURE__ */ e.jsx(
        fs,
        {
          currencySymbol: d,
      ...
      /* @__PURE__ */ e.jsxs("div", { className: "grid grid-cols-1 gap-6 lg:grid-cols-2", children: [
        ...
        /* @__PURE__ */ e.jsx(
          re,
          {
            ...
            children: /* @__PURE__ */ e.jsx("div", { className: "flex h-18 w-[100px] min-w-[100px] items-center justify-center rounded-md bg-gradient-to-tr from-[#14B8FF]/20 to-[#00BBA7]/20 p-4 opacity-80 transition-all group-hover/card:opacity-100", children: /* @__PURE__ */ e.jsx(Se, { className: "text-[#00BBA7]", size: 20, strokeWidth: 1.5 }) })
          }
        ),
        /* @__PURE__ */ e.jsx(
          re,
...
//# sourceMappingURL=index-C3gdXjoR.mjs.map
