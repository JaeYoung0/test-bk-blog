import { f as u, j as t, q as G, r as K, D as B, B as v, c as p, G as T } from "./index-B1MLE706.mjs";
import { bD as L, Q as W, R as q, _ as H, T as f, bE as C, bF as O, bG as Q, V as y, a1 as U, o as J, bH as X, bI as Y, B as Z, ah as ee } from "./stats-D3Sgo-rN.mjs";
var h = "Tabs", [te] = q(h, [
  C
]), w = C(), [ae, N] = te(h), k = u(
  (e, a) => {
...
var I = "TabsList", _ = u(
  (e, a) => {
    const { __scopeTabs: n, loop: s = !0, ...r } = e, i = N(I, n), o = w(n);
    return /* @__PURE__ */ t.jsx(
      O,
      {
        asChild: !0,
...
var V = "TabsTrigger", A = u(
  (e, a) => {
    const { __scopeTabs: n, value: s, disabled: r = !1, ...i } = e, o = N(V, n), d = w(n), g = M(o.baseId, s), m = P(o.baseId, s), c = s === o.value;
    return /* @__PURE__ */ t.jsx(
      Q,
      {
        asChild: !0,
...
var E = "TabsContent", F = u(
  (e, a) => {
    const { __scopeTabs: n, value: s, forceMount: r, children: i, ...o } = e, d = N(E, n), g = M(d.baseId, s), m = P(d.baseId, s), c = s === d.value, l = G(c);
    return K(() => {
...
var R = k, D = _, j = A, S = F;
const x = B("segmented"), se = u(({ variant: e = "segmented", ...a }, n) => /* @__PURE__ */ t.jsx(x.Provider, { value: e, children: /* @__PURE__ */ t.jsx(R, { ref: n, ...a }) }));
  ...
  return /* @__PURE__ */ t.jsxs("div", { className: p("group flex w-full flex-col items-start gap-2", o), children: [
    ...
    /* @__PURE__ */ t.jsxs("div", { className: "flex flex-col items-start gap-2 lg:flex-row xl:gap-3", children: [
      ...
      r && r !== "hidden" && /* @__PURE__ */ t.jsx(t.Fragment, { children: /* @__PURE__ */ t.jsxs("div", { className: m, "data-testid": d ? `${d}-diff` : void 0, children: [
        ...
        r === "up" && /* @__PURE__ */ t.jsx(X, { className: "!size-[12px]", size: 14, strokeWidth: 2 }),
        r === "down" && /* @__PURE__ */ t.jsx(Y, { className: "!size-[12px]", size: 14, strokeWidth: 2 })
      ] }) })
    ] })
  ] });
}, de = u(
...
const le = u(({
  ...
  return /* @__PURE__ */ t.jsxs("div", { className: "relative rounded-md hover:bg-muted", children: [
    /* @__PURE__ */ t.jsx(
      ...
      {
        ref: s,
        className: p(z({ variant: r, className: a })),
        ...n,
...
//# sourceMappingURL=tabs-DngAFxee.mjs.map
