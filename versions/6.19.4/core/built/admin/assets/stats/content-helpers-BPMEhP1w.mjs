import { f as p, v as z, C as g, w as y, j as i, x as T, F as G, c as f, S as W, G as I } from "./index-B1MLE706.mjs";
import { ad as L, X as M, bs as F } from "./stats-D3Sgo-rN.mjs";
import { R as Y, T as Z, P as H, C as E, e as U, a as A, D as O, O as P } from "./audience-MBuIJMEB.mjs";
...
function X(t) {
  const e = /* @__PURE__ */ q(t), o = p((s, r) => {
    ...
    if (u) {
      const n = u.props.children, m = l.map((S) => S === u ? g.count(n) > 1 ? g.only(null) : y(n) ? n.props.children : null : S);
      return /* @__PURE__ */ i.jsx(e, { ...c, ref: r, children: y(n) ? T(n, void 0, m) : null });
    }
...
function wt({
  ...
  let c = 0;
  if (t.forEach((n) => {
    const { domain: m, isDirectTraffic: S } = nt(n.source, o), v = Number(n.visits || 0);
    if (S || !n.source || n.source === "")
      c += v;
    else {
      const h = String(n.source), $ = m ? `https://www.faviconextractor.com/favicon/${m}?larger=true` : r, R = m ? `https://${m}` : void 0;
      if (a.has(h)) {
        const N = a.get(h);
        N.visits += v;
      } else {
  ...
  return Array.from(a.values()).sort((n, m) => m.visits - n.visits);
}
const ct = p(
...
const dt = I(
  ...
  /* @__PURE__ */ i.jsxs(
    ...
    {
      ref: r,
      className: f(dt({ side: t }), e),
      ...s,
      children: [
        /* @__PURE__ */ i.jsxs(U, { className: "fixed right-4 top-4 z-50 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 disabled:pointer-events-none data-[state=open]:bg-secondary", children: [
...
const mt = p(({ className: t, ...e }, o) => /* @__PURE__ */ i.jsx(
  ...
  {
    ref: o,
    className: f("text-xl font-semibold text-foreground", t),
    ...e
  }
));
mt.displayName = A.displayName;
const ft = p(({ className: t, ...e }, o) => /* @__PURE__ */ i.jsx(
  O,
  {
    ref: o,
    className: f("text-sm text-muted-foreground", t),
    ...e
  }
));
ft.displayName = O.displayName;
...
//# sourceMappingURL=content-helpers-BPMEhP1w.mjs.map
