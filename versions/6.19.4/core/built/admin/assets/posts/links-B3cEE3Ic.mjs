import { t as N, R as p, l as Le, P as he, j as f, n as He, f as Je } from "./index-Cr7pONoj.mjs";
import { q as v, ad as De, ae as Xe, af as Ce, ag as Ye, o as Q, p as Ie, ah as $, L as k, ai as Be, t as H, u as ze, W as et, aj as tt, I as rt, J as ce, O as nt, Q as Me, n as ue, G as at, ak as it, al as ot, am as st, an as ct, ao as lt, U as ut, ap as ge, aq as ft, Z as pt, ar as dt, $ as yt, a1 as mt, as as ht } from "./tabs-DLdxkLUO.mjs";
import { a as bt, b as gt } from "./hooks-CBG95Unn.mjs";
          ...
          children: [
            /* @__PURE__ */ f.jsxs("defs", { children: [
              /* @__PURE__ */ f.jsxs("radialGradient", { cx: "30%", cy: "30%", id: "gradientPurple", r: "70%", children: [
                /* @__PURE__ */ f.jsx("stop", { offset: "0%", stopColor: "hsl(var(--chart-purple))", stopOpacity: 0.5 }),
                /* @__PURE__ */ f.jsx("stop", { offset: "100%", stopColor: "hsl(var(--chart-purple))", stopOpacity: 1 })
              ] }),
              /* @__PURE__ */ f.jsxs("radialGradient", { cx: "30%", cy: "30%", id: "gradientBlue", r: "70%", children: [
                /* @__PURE__ */ f.jsx("stop", { offset: "0%", stopColor: "hsl(var(--chart-blue))", stopOpacity: 0.5 }),
                /* @__PURE__ */ f.jsx("stop", { offset: "100%", stopColor: "hsl(var(--chart-blue))", stopOpacity: 1 })
              ] }),
              /* @__PURE__ */ f.jsxs("radialGradient", { cx: "30%", cy: "30%", id: "gradientTeal", r: "70%", children: [
                /* @__PURE__ */ f.jsx("stop", { offset: "0%", stopColor: "hsl(var(--chart-teal))", stopOpacity: 0.5 }),
                /* @__PURE__ */ f.jsx("stop", { offset: "100%", stopColor: "hsl(var(--chart-teal))", stopOpacity: 1 })
              ] }),
              /* @__PURE__ */ f.jsxs("radialGradient", { cx: "30%", cy: "30%", id: "gradientGray", r: "70%", children: [
                /* @__PURE__ */ f.jsx("stop", { offset: "0%", stopColor: "hsl(var(--chart-gray))", stopOpacity: 0.5 }),
                /* @__PURE__ */ f.jsx("stop", { offset: "100%", stopColor: "hsl(var(--chart-gray))", stopOpacity: 1 })
              ] })
            ] }),
...
//# sourceMappingURL=links-B3cEE3Ic.mjs.map
