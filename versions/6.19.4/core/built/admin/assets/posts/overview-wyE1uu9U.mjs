import { c as J, d as V, a as g, j as e, f as T, e as y, g as ie, h as le, i as ne, k as q, s as ce, b as oe } from "./index-Cr7pONoj.mjs";
import { u as de, c as me, D as he } from "./growth-Ba1IRvpm.mjs";
import { K as R, a as I, b as D, c as S } from "./stats-BY3FHp0A.mjs";
import { B as z, H as X } from "./heading-eNl0HQ4y.mjs";
import { C as E, a as $, b as M, c as C, K as A, d as K, e as O, G as U, u as Q, h as xe, i as ue, P as pe, f as je, S as fe } from "./post-analytics-header-C12M4x9k.mjs";
import { D as ge, a as ve, b as be, c as Ne, d as ye, e as we, f as ke, g as Ce } from "./tabs-DLdxkLUO.mjs";
import { B as W } from "./loading-indicator-PS-AyPMj.mjs";
import { S as P } from "./separator-Bs9v0qlT.mjs";
import { u as Le, p as _e, N as Te, c as Re } from "./links-B3cEE3Ic.mjs";
import { M as Ie } from "./get-site-timezone--CtXRVG8.mjs";
import { L as De } from "./post-share-modal-DdcjQ0rG.mjs";
import { G as Se, S as Ae, K as Ke } from "./kpis-DgSj_Rer.mjs";
import { E as Oe } from "./empty-indicator-Bu5ew_PQ.mjs";
import { u as Z, S as Pe } from "./post-analytics-context-D9F5l8mV.mjs";
import { S as Y } from "./skeleton-nGxKIBIH.mjs";
const Ve = ({ post: d, isNewsletterStatsLoading: n, isWebShown: u }) => {
      ...
      /* @__PURE__ */ e.jsxs("div", { className: `${c && "border-r pr-6"}`, children: [
        /* @__PURE__ */ e.jsxs("div", { className: "grid grid-cols-2 gap-6", children: [
          /* @__PURE__ */ e.jsx(A, { className: "group relative flex grow flex-row items-start justify-between gap-5 border-none px-0 pt-0", children: /* @__PURE__ */ e.jsxs("div", { className: "flex grow flex-col gap-1.5 border-none pb-0", children: [
            /* @__PURE__ */ e.jsx(K, { color: "hsl(var(--chart-blue))", children: "Open rate" }),
            /* @__PURE__ */ e.jsx(
              O,
              {
          ...
          /* @__PURE__ */ e.jsx(A, { className: "group relative flex grow flex-row items-start justify-between gap-5 border-none px-0 pt-0", children: /* @__PURE__ */ e.jsxs("div", { className: "flex grow flex-col gap-1.5 border-none pb-0", children: [
            /* @__PURE__ */ e.jsx(K, { color: "hsl(var(--chart-teal))", children: "Click rate" }),
            /* @__PURE__ */ e.jsx(
              O,
              {
  ...
  const { postId: l } = J(), p = V(), { data: m } = Z(), a = m == null ? void 0 : m.url, c = m == null ? void 0 : m.icon, o = g(() => t ? t.reduce((i, x) => i + Number(x.visits || 0), 0) : 0, [t]);
    ...
    /* @__PURE__ */ e.jsxs(C, { children: [
      /* @__PURE__ */ e.jsxs("div", { children: [
        /* @__PURE__ */ e.jsx(A, { className: "group relative flex grow flex-row items-start justify-between gap-5 border-none px-0 pt-0", "data-testid": "unique-visitors", children: /* @__PURE__ */ e.jsxs("div", { className: "flex grow flex-col gap-1.5 border-none pb-0", children: [
          /* @__PURE__ */ e.jsx(K, { color: "hsl(var(--chart-blue))", children: "Unique visitors" }),
          /* @__PURE__ */ e.jsx(
            O,
            {
              value: y(s)
  ...
  var H;
  const d = V(), { statsConfig: n, isLoading: u, post: s, isPostLoading: t, postId: r } = Z(), { totals: l, isLoading: p, currencySymbol: m } = de(r), { appSettings: a } = ie(), { emailTrackClicks: c, emailTrackOpens: o } = (a == null ? void 0 : a.analytics) || {}, i = g(() => s != null && s.published_at ? le(s.published_at) : Pe.ALL_TIME.value, [s == null ? void 0 : s.published_at]), { startDate: x, endDate: v, timezone: b } = ne(i), N = g(() => {
    const h = {
  ...
  }, [t, s, n == null ? void 0 : n.id, x, v, b]), { data: j, loading: G } = Q({
    endpoint: "api_kpis",
    statsConfig: n || { id: "" },
    params: N
  }), ee = g(() => j != null && j.length ? j.reduce((h, f) => {
    const F = Number(f.visits);
    return h + (isNaN(F) ? 0 : F);
  }, 0) : 0, [j]), w = Ke.visits, se = (H = ce(j || [], i, w.dataKey, "sum")) == null ? void 0 : H.map((h) => {
    const f = Number(h[w.dataKey]);
    return {
      date: String(h.date),
      value: f,
    ...
    statsConfig: n || { id: "" },
    params: N
  }), B = u || p || t || G, re = t || u || G, L = xe(s) && o && c, _ = !(s != null && s.email_only) && (a == null ? void 0 : a.analytics.webAnalytics), k = a == null ? void 0 : a.analytics.membersTrackSources;
  return oe(() => {
    ...
    /* @__PURE__ */ e.jsx(je, { children: /* @__PURE__ */ e.jsxs("div", { className: "flex flex-col gap-6 lg:grid lg:grid-cols-2", children: [
      ...
      k && /* @__PURE__ */ e.jsxs(E, { className: "group col-span-2 overflow-hidden p-0", "data-testid": "growth", children: [
        ...
        /* @__PURE__ */ e.jsx(C, { className: "flex flex-col gap-6 px-0 md:grid md:grid-cols-3 md:items-stretch md:gap-0", children: B ? Array.from({ length: 3 }, (h, f) => /* @__PURE__ */ e.jsxs("div", { className: "h-[98px] gap-1 border-r px-6 py-5 last:border-r-0", children: [
      ...
      !_ && !L && !k && /* @__PURE__ */ e.jsx(he, { className: "col-span-2 py-20" })
    ] }) })
  ] });
};
export {
...
//# sourceMappingURL=overview-wyE1uu9U.mjs.map
