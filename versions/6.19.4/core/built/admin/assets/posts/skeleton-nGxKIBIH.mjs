import { R as g, j as s, B as ee, A as te, D as P, b as U, q as k, u as G, o as N, a as oe, n as B } from "./index-Cr7pONoj.mjs";
import { d as q, h as j, m as L, e as ne, P as V, f as E, b as re, u as se } from "./heading-eNl0HQ4y.mjs";
function ce(e) {
  const t = e + "CollectionProvider", [c, n] = q(t), [b, m] = c(
    t,
    { collectionRef: { current: null }, itemMap: /* @__PURE__ */ new Map() }
  ), l = (p) => {
    const { scope: o, children: u } = p, I = g.useRef(null), a = g.useRef(/* @__PURE__ */ new Map()).current;
    return /* @__PURE__ */ s.jsx(b, { scope: o, itemMap: a, collectionRef: I, children: u });
  };
  l.displayName = t;
  const x = e + "CollectionSlot", h = L(x), f = g.forwardRef(
    (p, o) => {
  ...
  f.displayName = x;
  const r = e + "CollectionItemSlot", v = "data-radix-collection-item", C = L(r), R = g.forwardRef(
    (p, o) => {
      const { scope: u, children: I, ...a } = p, i = g.useRef(null), T = j(o, i), w = m(r, u);
      return g.useEffect(() => (w.itemMap.set(i, { ref: i, ...a }), () => void w.itemMap.delete(i))), /* @__PURE__ */ s.jsx(C, { [v]: "", ref: T, children: I });
    }
  );
  R.displayName = r;
  function S(p) {
...
var pe = P((e, t) => {
  const {
    ...
    ...v
  } = e, C = k(null), R = j(t, C), S = le(m), [p, o] = re({
    prop: l,
    defaultProp: x ?? null,
    onChange: h,
    caller: y
  ...
  (e, t) => {
    const {
      ...
      children: l,
      ...x
    } = e, h = ne(), f = m || h, r = me(H, c), v = r.currentTabStopId === f, C = Y(c), { onFocusableItemAdd: R, onFocusableItemRemove: S, currentTabStopId: p } = r;
    return U(() => {
      if (n)
        return R(), () => S();
    }, [n, R, S]), /* @__PURE__ */ s.jsx(
      D.ItemSlot,
      {
        scope: c,
        id: f,
...
function K({
  ...
  const { randomWidths: x, keys: h } = oe(() => {
    ...
    for (let v = 0; v < t; v++) {
      if (c) {
        const C = Math.floor((b - n) / 5), R = Math.floor(Math.random() * (C + 1)), S = n + R * 5;
        f.push(`${S}%`);
      }
  ...
  return /* @__PURE__ */ s.jsx("span", { className: e, children: Array.from({ length: t }).map((f, r) => /* @__PURE__ */ s.jsxs(g.Fragment, { children: [
    /* @__PURE__ */ s.jsx(
      "span",
      {
...
const Re = g.forwardRef(({ className: e, lines: t = 5, ...c }, n) => t < 1 ? /* @__PURE__ */ s.jsx(s.Fragment, {}) : /* @__PURE__ */ s.jsx("div", { ref: n, className: B("flex flex-col gap-2", e), ...c, children: Array.from({ length: t }, (b, m) => {
  let l = "66%";
  switch (m % 5) {
    case 0:
      l = "57%";
...
//# sourceMappingURL=skeleton-nGxKIBIH.mjs.map
