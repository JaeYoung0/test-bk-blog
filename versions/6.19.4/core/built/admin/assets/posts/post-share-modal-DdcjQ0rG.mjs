import { u as k, j as e } from "./index-Cr7pONoj.mjs";
import { g as N, B as t, l as w } from "./heading-eNl0HQ4y.mjs";
import { g as C, h as y, i as z, X as M, j as H, k as $, l as P, m as D, C as V } from "./dialog-B8wFkz_u.mjs";
/**
...
const B = [
  ...
  emailOnly: x = !1,
  postURL: s = "",
  primaryTitle: m = "Your post is published.",
  secondaryTitle: p = "Spread the word!",
  description: a = "",
  featureImageURL: i = "",
  postTitle: l = "",
  postExcerpt: n = "",
  ...
  const [o, d] = k(!1), _ = async () => {
    try {
      await navigator.clipboard.writeText(s), d(!0), setTimeout(() => d(!1), 2e3);
    } catch {
    }
  }, h = encodeURIComponent(l), r = encodeURIComponent(s), b = encodeURIComponent(`${l} ${s}`);
  return /* @__PURE__ */ e.jsxs(C, { ...v, children: [
    /* @__PURE__ */ e.jsx(y, { className: "cursor-pointer", asChild: !0, children: u }),
    /* @__PURE__ */ e.jsxs(z, { className: "max-h-[calc(100vh-16vmin)] max-w-[540px] overflow-y-auto p-8", children: [
      /* @__PURE__ */ e.jsx("div", { className: "sticky top-0 ml-auto size-0", children: /* @__PURE__ */ e.jsx(t, { className: "absolute -right-5 -top-5 cursor-pointer p-2 text-muted-foreground hover:text-foreground [&_svg]:!size-6", size: "lg", variant: "link", onClick: c, children: /* @__PURE__ */ e.jsx(M, { size: 24, strokeWidth: 1 }) }) }),
      /* @__PURE__ */ e.jsxs(H, { className: "relative -mt-5", children: [
        /* @__PURE__ */ e.jsxs($, { className: "text-3xl font-bold leading-[1.15em]", children: [
          /* @__PURE__ */ e.jsx("span", { className: "text-green-500", children: m }),
          /* @__PURE__ */ e.jsx("br", {}),
          /* @__PURE__ */ e.jsx("span", { children: p })
        ] }),
        a && /* @__PURE__ */ e.jsx(P, { className: "mb-0 pb-0 pt-1 text-lg text-foreground", children: a })
      ] }),
      /* @__PURE__ */ e.jsxs("a", { className: "flex flex-col items-stretch overflow-hidden rounded-md border transition-all hover:border-muted-foreground/40", href: s, rel: "noopener noreferrer", target: "_blank", children: [
        i && /* @__PURE__ */ e.jsx("div", { className: "aspect-video bg-cover bg-center", style: {
          backgroundImage: `url(${i})`
        } }),
        /* @__PURE__ */ e.jsxs("div", { className: "p-6 pt-5", children: [
          /* @__PURE__ */ e.jsx(w, { children: l }),
          ...
          /* @__PURE__ */ e.jsxs("div", { className: "mt-2 flex items-start gap-2", children: [
            ...
            /* @__PURE__ */ e.jsxs("div", { className: "flex gap-1", children: [
              /* @__PURE__ */ e.jsx("strong", { children: g }),
      ...
      /* @__PURE__ */ e.jsx(D, { className: "justify-between gap-6", children: x ? /* @__PURE__ */ e.jsx(t, { className: "cursor-pointer", type: "submit", onClick: c, children: "Close" }) : /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
        /* @__PURE__ */ e.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ e.jsx("a", { className: "flex h-[34px] w-14 items-center justify-center rounded-sm bg-muted px-3 hover:bg-muted-foreground/20 [&_svg]:h-4", href: `https://twitter.com/intent/tweet?text=${h}%0A${r}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ e.jsx("svg", { "aria-hidden": "true", viewBox: "0 0 24 24", children: /* @__PURE__ */ e.jsx("path", { className: "social-x_svg__x", d: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" }) }) }),
          /* @__PURE__ */ e.jsx("a", { className: "flex h-[34px] w-14 items-center justify-center rounded-sm bg-muted px-3 hover:bg-muted-foreground/20 [&_svg]:h-4", href: `https://threads.net/intent/post?text=${b}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ e.jsxs("svg", { fill: "none", viewBox: "0 0 18 18", children: [
          ...
          /* @__PURE__ */ e.jsx("a", { className: "flex h-[34px] w-14 items-center justify-center rounded-sm bg-muted px-3 hover:bg-muted-foreground/20 [&_svg]:h-4", href: `https://www.facebook.com/sharer/sharer.php?u=${r}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ e.jsxs("svg", { fill: "none", viewBox: "0 0 40 40", children: [
          ...
          /* @__PURE__ */ e.jsx("a", { className: "flex h-[34px] w-14 items-center justify-center rounded-sm bg-muted px-3 hover:bg-muted-foreground/20 [&_svg]:h-4", href: `http://www.linkedin.com/shareArticle?mini=true&title=${h}&url=${r}`, rel: "noopener noreferrer", target: "_blank", children: /* @__PURE__ */ e.jsxs("svg", { fill: "none", viewBox: "0 0 16 16", children: [
        ...
        /* @__PURE__ */ e.jsxs(
          t,
          {
            ...
            onClick: _,
            children: [
              o ? /* @__PURE__ */ e.jsx(V, {}) : /* @__PURE__ */ e.jsx(I, {}),
              o ? "Copied!" : "Copy link"
            ]
          }
        )
...
//# sourceMappingURL=post-share-modal-DdcjQ0rG.mjs.map
