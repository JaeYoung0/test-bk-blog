import { d as O, j as s, g as A, R as E, n as G, e as b, a as g, c as V } from "./index-Cr7pONoj.mjs";
import { B as H } from "./heading-eNl0HQ4y.mjs";
import { E as K } from "./empty-indicator-Bu5ew_PQ.mjs";
import { A as q, C, a as v, b as S, g as $, c as w, j as J, T as Q, P as X, f as Y, W as Z, m as ss } from "./post-analytics-header-C12M4x9k.mjs";
import { p as es, e as rs, S as L } from "./source-icon-DayHMhxh.mjs";
import { S as as, a as ts, b as cs, c as ns, d as os, e as is } from "./sheet-DWYoU37e.mjs";
import { T as ls, a as ds, b as R, c as N, d as ms, e as y } from "./table-tG8dmQHx.mjs";
import { U as hs } from "./get-site-timezone--CtXRVG8.mjs";
import { u as xs, d as us, e as js, K as k, f as W, a as M, b as T, c as P } from "./stats-BY3FHp0A.mjs";
import { S as D } from "./separator-Bs9v0qlT.mjs";
import { S as F, a as ps } from "./skeleton-nGxKIBIH.mjs";
import { u as bs } from "./post-analytics-context-D9F5l8mV.mjs";
import { U as fs } from "./dropdown-menu-uWe6MnwA.mjs";
function _(a) {
  ...
  return /* @__PURE__ */ s.jsxs(C, { className: G("group/datalist w-full max-w-[calc(100vw-64px)] overflow-x-auto sidebar:max-w-[calc(100vw-64px-280px)]", j), "data-testid": "top-sources-card", children: [
    ...
    x.length > 10 && /* @__PURE__ */ s.jsx(J, { children: /* @__PURE__ */ s.jsxs(as, { children: [
      ...
      /* @__PURE__ */ s.jsxs(cs, { className: "overflow-y-auto pt-0 sm:max-w-[600px]", children: [
        /* @__PURE__ */ s.jsxs(ns, { className: "sticky top-0 z-40 -mx-6 bg-background/60 p-6 backdrop-blur", children: [
...
//# sourceMappingURL=growth-Ba1IRvpm.mjs.map
