import { B, A as N, c as w, u as O, j as U } from "./index-Cr7pONoj.mjs";
import { u as R, a as Y } from "./settings-DLsjFr5N.mjs";
import { u as x } from "./posts-CRiBkqxa.mjs";
import { a as S } from "./hooks-CBG95Unn.mjs";
...
const M = (t = {}) => {
  ...
  }), l = [s, e, r], P = l.map((u) => u.error).find(Boolean), k = c ? d.error : null, g = P || k, E = l.some((u) => u.isLoading), I = c ? d.isLoading : !1, D = E || I;
  if (g)
    throw g;
...
//# sourceMappingURL=post-analytics-context-D9F5l8mV.mjs.map
