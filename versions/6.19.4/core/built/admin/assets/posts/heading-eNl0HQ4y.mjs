import { o as A, A as _, a as b, j as l, B as L, U as F, q as C, b as P, u as O, E as N, D as p, F as y, G as g, H as j, J as W, a3 as V, v as $, n as v, T as U } from "./index-Cr7pONoj.mjs";
function I(t, e) {
...
function Et(t, e = []) {
  ...
  function o(s, c) {
    ...
    const u = (f) => {
      var E;
      const { scope: m, children: h, ...x } = f, S = ((E = m == null ? void 0 : m[t]) == null ? void 0 : E[a]) || i, z = b(() => x, Object.values(x));
      return /* @__PURE__ */ l.jsx(S.Provider, { value: z, children: h });
    };
    u.displayName = s + "Provider";
    function d(f, m) {
      var S;
      const h = ((S = m == null ? void 0 : m[t]) == null ? void 0 : S[a]) || i, x = L(h);
      if (x) return x;
...
var T = globalThis != null && globalThis.document ? F : () => {
}, q = N[" useInsertionEffect ".trim().toString()] || T;
function Rt({
  prop: t,
  defaultProp: e,
  onChange: n = () => {
...
function M(t) {
  return g(t) && typeof t.type == "function" && "__radixId" in t.type && t.type.__radixId === B;
}
function Q(t, e) {
  const n = { ...e };
  for (const o in e) {
...
var tt = [
  ...
  const n = /* @__PURE__ */ J(`Primitive.${e}`), o = p((r, s) => {
...
function st(t) {
  const e = /* @__PURE__ */ ct(t), n = p((o, r) => {
    let { children: s, ...c } = o;
    D(s) && typeof w == "function" && (s = w(s._payload));
...
function ct(t) {
  const e = p((n, o) => {
    let { children: r, ...s } = n;
    if (D(r) && typeof w == "function" && (r = w(r._payload)), g(r)) {
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const xt = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]], bt = vt("chevron-down", xt), ht = U(
  ...
  ({ className: t, variant: e, size: n, asChild: o = !1, children: r, ...s }, c) => {
    const i = o ? it : "button", a = e === "dropdown" ? /* @__PURE__ */ l.jsxs(l.Fragment, { children: [
      r,
      /* @__PURE__ */ l.jsx(bt, { className: "!-ml-1 !-mr-0.5 size-4 !stroke-[2px] opacity-50", strokeWidth: 2 })
    ] }) : r;
    return /* @__PURE__ */ l.jsx(
      i,
      {
        ref: c,
        className: v(ht({ variant: e, size: n, className: t })),
        ...s,
        children: a
      }
    );
...
//# sourceMappingURL=heading-eNl0HQ4y.mjs.map
