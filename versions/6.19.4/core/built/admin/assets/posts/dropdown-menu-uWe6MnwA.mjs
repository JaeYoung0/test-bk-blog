import { a as Xe, P as ne, d as Qe, h as de, u as et, g as He, f as E, n as Jn, m as Qn, c as Dt, b as eo, e as vt } from "./heading-eNl0HQ4y.mjs";
import { u as K, o as X, q as N, a3 as to, U as no, b as re, a as Ne, D as C, j as m, J as oo, W as Ot, n as ae } from "./index-Cr7pONoj.mjs";
import { b as ro, c as Nt, u as io, I as so, R as co } from "./skeleton-nGxKIBIH.mjs";
import { P as ze, n as ao, o as lo, u as uo, p as fo, F as po, q as mo, C as ho } from "./dialog-B8wFkz_u.mjs";
function go(e) {
  const [t, n] = K(void 0);
  return Xe(() => {
    if (e) {
...
const xo = ["top", "right", "bottom", "left"], ie = Math.min, z = Math.max, je = Math.round, Ie = Math.floor, se = (e) => ({
  x: e,
  y: e
}), wo = {
  left: "right",
...
const So = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if (v && !d) {
        const b = z(c.left, 0), R = z(c.right, 0), j = z(c.top, 0), T = z(c.bottom, 0);
        l ? P = f - 2 * (b !== 0 || R !== 0 ? b + R : z(c.left, c.right)) : A = p - 2 * (j !== 0 || T !== 0 ? j + T : z(c.top, c.bottom));
      }
      await s({
        ...t,
        availableWidth: P,
...
function jt(e) {
  const t = he(e);
  return Ke(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : Z(t) && Ee(t) ? t : jt(t);
}
function Fe(e, t) {
  var n;
  t === void 0 && (t = []);
...
function $o(e) {
  const t = oe(e), n = We(e), o = e.ownerDocument.body, r = z(t.scrollWidth, t.clientWidth, o.scrollWidth, o.clientWidth), i = z(t.scrollHeight, t.clientHeight, o.scrollHeight, o.clientHeight);
  let s = -n.scrollLeft + Ft(e);
  const a = -n.scrollTop;
  return Y(o).direction === "rtl" && (s += z(t.clientWidth, o.clientWidth) - r), {
    width: r,
    height: i,
    x: s,
    y: a
...
function $t(e, t) {
  const n = he(e);
  return n === t || !te(n) || Ke(n) ? !1 : Y(n).position === "fixed" || $t(n, t);
}
function Ho(e, t) {
  const n = t.get(e);
  if (n)
...
function zo(e) {
  ...
  const s = [...n === "clippingAncestors" ? Ho(t, this._c) : [].concat(n), o], a = s[0], c = s.reduce((u, d) => {
    const l = Pt(t, d, r);
    return u.top = z(l.top, u.top), u.right = ie(l.right, u.right), u.bottom = ie(l.bottom, u.bottom), u.left = z(l.left, u.left), u;
  }, Pt(t, a, r));
  return {
...
function Qo(e) {
  ...
  $e(f, o) || p(o);
  const [h, g] = K(null), [w, x] = K(null), v = X((_) => {
...
Ht.displayName = er;
var tr = Ht, ct = "Popper", [zt, Kt] = Qe(ct), [nr, Wt] = zt(ct), Vt = (e) => {
...
Yt.displayName = Ut;
var at = "PopperContent", [or, rr] = zt(at), Xt = C(
  (e, t) => {
    var J, ye, V, be, gt, xt;
    const {
      __scopePopper: n,
      ...
      onPlaced: h,
      ...g
    } = e, w = Wt(at, n), [x, v] = K(null), A = de(t, (Me) => v(Me)), [P, y] = K(null), b = go(P), R = (b == null ? void 0 : b.width) ?? 0, j = (b == null ? void 0 : b.height) ?? 0, T = o + (i !== "center" ? "-" + i : ""), k = typeof d == "number" ? d : { top: 0, right: 0, bottom: 0, left: 0, ...d }, O = Array.isArray(u) ? u : [u], L = O.length > 0, S = {
      padding: k,
    ...
    const q = (J = I.arrow) == null ? void 0 : J.x, we = (ye = I.arrow) == null ? void 0 : ye.y, ve = ((V = I.arrow) == null ? void 0 : V.centerOffset) !== 0, [De, le] = K();
    return Xe(() => {
...
var Je = ["Enter", " "], wr = ["ArrowDown", "PageUp", "Home"], Qt = ["ArrowUp", "PageDown", "End"], vr = [...wr, ...Qt], yr = {
  ...
  Kt,
  Nt
]), Ve = Kt(), tn = Nt(), [Ar, pe] = fe(Re), [Pr, Se] = fe(Re), nn = (e) => {
  const { __scopeMenu: t, open: n = !1, children: o, dir: r, onOpenChange: i, modal: s = !0 } = e, a = Ve(t), [c, u] = K(null), d = N(!1), l = et(i), f = io(r);
  return re(() => {
    const p = () => {
...
var ut = "MenuPortal", [Er, on] = fe(ut, {
  ...
  return /* @__PURE__ */ m.jsx(Er, { scope: t, forceMount: n, children: /* @__PURE__ */ m.jsx(ze, { present: n || i.open, children: /* @__PURE__ */ m.jsx(ao, { asChild: !0, container: r, children: o }) }) });
};
rn.displayName = ut;
var U = "MenuContent", [Rr, dt] = fe(U), sn = C(
  (e, t) => {
    ...
    return /* @__PURE__ */ m.jsx(Pe.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ m.jsx(ze, { present: o || i.open, children: /* @__PURE__ */ m.jsx(Pe.Slot, { scope: e.__scopeMenu, children: s.modal ? /* @__PURE__ */ m.jsx(Sr, { ...r, ref: t }) : /* @__PURE__ */ m.jsx(Dr, { ...r, ref: t }) }) }) });
  }
), Sr = C(
  (e, t) => {
  ...
  (e, t) => {
    const {
      ...
      ...g
    } = e, w = pe(U, n), x = Se(U, n), v = Ve(n), A = tn(n), P = Mr(n), [y, b] = K(null), R = N(null), j = de(t, R, w.onContentChange), T = N(0), k = N(""), O = N(0), L = N(null), S = N("right"), D = N(0), F = h ? fo : oo, _ = h ? { as: Or, allowPinchZoom: !0 } : void 0, H = (M) => {
      var J, ye;
      const G = k.current + M, $ = P().filter((V) => !V.disabled), q = document.activeElement, we = (J = $.find((V) => V.ref.current === q)) == null ? void 0 : J.textValue, ve = $.map((V) => V.textValue), De = zr(ve, G, we), le = (ye = $.find((V) => V.textValue === De)) == null ? void 0 : ye.ref.current;
      (function V(be) {
...
var an = C(
  (e, t) => {
    const { __scopeMenu: n, disabled: o = !1, textValue: r, ...i } = e, s = dt(Be, n), a = tn(n), c = N(null), u = de(t, c), [d, l] = K(!1), [f, p] = K("");
    return re(() => {
      const h = c.current;
...
var yn = "MenuSubContent", bn = C(
  (e, t) => {
    ...
    return /* @__PURE__ */ m.jsx(Pe.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ m.jsx(ze, { present: o || i.open, children: /* @__PURE__ */ m.jsx(Pe.Slot, { scope: e.__scopeMenu, children: /* @__PURE__ */ m.jsx(
      ft,
      {
        id: a.contentId,
...
Fn.displayName = Mi;
var Ci = An, Ai = _n, Pi = En, $n = Sn, _i = Dn, Bn = On, Gn = Nn, Hn = In, zn = Tn, Kn = jn, Wn = kn, Vn = Ln, Un = Fn;
const Hi = Ci, zi = Ai, Ki = _i, Ei = C(({ className: e, inset: t, children: n, ...o }, r) => /* @__PURE__ */ m.jsxs(
  Vn,
  {
    ref: r,
    className: ae(
...
const Oi = C(({ className: e, children: t, checked: n, ...o }, r) => /* @__PURE__ */ m.jsxs(
  Hn,
  {
    ...
    ...o,
    children: [
      /* @__PURE__ */ m.jsx("span", { className: "absolute left-2 flex size-3.5 items-center justify-center", children: /* @__PURE__ */ m.jsx(Kn, { children: /* @__PURE__ */ m.jsx(ho, { className: "size-4" }) }) }),
      t
    ]
  }
));
...
const Ni = C(({ className: e, children: t, ...n }, o) => /* @__PURE__ */ m.jsxs(
  zn,
  {
    ...
    ...n,
    children: [
      /* @__PURE__ */ m.jsx("span", { className: "absolute left-2 flex size-3.5 items-center justify-center", children: /* @__PURE__ */ m.jsx(Kn, { children: /* @__PURE__ */ m.jsx(hr, { className: "size-2 fill-current" }) }) }),
      t
    ]
  }
));
Ni.displayName = zn.displayName;
...
//# sourceMappingURL=dropdown-menu-uWe6MnwA.mjs.map
