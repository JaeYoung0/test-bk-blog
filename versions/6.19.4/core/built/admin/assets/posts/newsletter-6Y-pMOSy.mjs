import { A as he, a as j, j as e, B as st, D as R, E as at, F as M, G as W, H as ye, J as rt, u as $, b as D, q as ae, n as E, R as U, c as nt, d as Ce, f as A, K as be, L as it, M as ot, N as lt, g as ct, e as O } from "./index-Cr7pONoj.mjs";
import { c as dt, u as ut, a as re, B as V, H as Le } from "./heading-eNl0HQ4y.mjs";
import { s as mt, c as pt } from "./hooks-CBG95Unn.mjs";
import { C as ne, a as ie, b as oe, g as le, c as T, j as Pe, T as gt, h as xt, P as ft, f as ht, n as bt } from "./post-analytics-header-C12M4x9k.mjs";
import { S as ce } from "./separator-Bs9v0qlT.mjs";
import { a8 as vt, a2 as jt, a3 as kt, a4 as Nt, a9 as ve, aa as wt, ab as yt, D as Ct, a as Lt, b as Pt, c as St, d as _t, e as At, f as Rt, g as Ft, ac as $t } from "./tabs-DLdxkLUO.mjs";
import { a as Se } from "./skeleton-nGxKIBIH.mjs";
import { g as Et, h as Tt, K as Z, f as J, a as Q, b as X, c as ee } from "./stats-BY3FHp0A.mjs";
import { B as It } from "./loading-indicator-PS-AyPMj.mjs";
import { a as zt, u as Bt, p as Mt, g as te, N as se } from "./links-B3cEE3Ic.mjs";
import { u as Dt } from "./post-analytics-context-D9F5l8mV.mjs";
import { g as je } from "./posts-CRiBkqxa.mjs";
import { C as Vt } from "./dropdown-menu-uWe6MnwA.mjs";
function Ut(t, s = []) {
  let a = [];
  function r(n, o) {
    const l = he(o);
    ...
    const m = (x) => {
      var h;
      const { scope: g, children: k, ...p } = x, f = ((h = g == null ? void 0 : g[t]) == null ? void 0 : h[u]) || l, v = j(() => p, Object.values(p));
      return /* @__PURE__ */ e.jsx(f.Provider, { value: v, children: k });
    };
...
function Gt(t) {
  const s = /* @__PURE__ */ Kt(t), a = R((r, i) => {
    ...
    const l = M.toArray(n), u = l.find(Yt);
    if (u) {
      const m = u.props.children, c = l.map((x) => x === u ? M.count(m) > 1 ? M.only(null) : W(m) ? m.props.children : null : x);
...
function Kt(t) {
  const s = R((a, r) => {
    ...
    if (_e(i) && typeof H == "function" && (i = H(i._payload)), W(i)) {
      const o = Jt(i), l = Zt(n, i.props);
      return i.type !== rt && (l.ref = r ? dt(r, o) : o), ye(i, l);
    }
    return M.count(i) > 1 ? M.only(null) : null;
  });
...
var Ie = Re, ze = $e, Be = Te;
const Me = R(({ className: t, ...s }, a) => /* @__PURE__ */ e.jsx(
  Ie,
  {
    ref: a,
    className: E(
...
const ge = U.forwardRef(
  ({ variant: t = "outline", ...s }, a) => /* @__PURE__ */ e.jsx(V, { ref: a, size: "sm", variant: t, ...s, children: /* @__PURE__ */ e.jsx(vt, {}) })
);
...
const is = "FeedbackResponseType", os = pt({
  ...
  return /* @__PURE__ */ e.jsxs(ne, { children: [
    ...
    t.totalFeedback > 0 ? /* @__PURE__ */ e.jsxs(T, { className: "pb-3", children: [
      /* @__PURE__ */ e.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
        /* @__PURE__ */ e.jsx(kt, { className: "pb-3", defaultValue: "positive", value: r, variant: "button", onValueChange: (v) => i(v), children: /* @__PURE__ */ e.jsxs(Nt, { className: "gap-1", children: [
        ...
        /* @__PURE__ */ e.jsx(Le, { className: "mb-3 mr-2 lg:hidden xl:!visible xl:!block", children: "Date" })
      ] }),
      /* @__PURE__ */ e.jsx(ce, {}),
      f ? /* @__PURE__ */ e.jsx(Se, { className: "mt-3", lines: 3 }) : c && c.length > 0 ? /* @__PURE__ */ e.jsx("div", { className: "flex w-full flex-col py-3", children: c.map((v) => {
        var h, L;
        return /* @__PURE__ */ e.jsxs("div", { className: "flex h-10 w-full items-center justify-between gap-3 rounded-sm border-none px-2 text-sm hover:cursor-pointer hover:bg-accent", onClick: () => {
          a(`/members/${v.member.id}`, { crossApp: !0 });
        }, children: [
          /* @__PURE__ */ e.jsxs("div", { className: "flex items-center gap-2 font-medium", children: [
            /* @__PURE__ */ e.jsxs(Me, { className: "size-7", children: [
              ((h = v.member) == null ? void 0 : h.avatar_image) && /* @__PURE__ */ e.jsx("img", { className: "absolute aspect-square size-full", src: (L = v.member) == null ? void 0 : L.avatar_image }),
              /* @__PURE__ */ e.jsx(De, { className: "text-white", style: {
                backgroundColor: `${ot(be(v.member), 75, 55)}`
              }, children: it(v.member) })
            ] }),
            be(v.member)
          ] }),
          /* @__PURE__ */ e.jsx("div", { className: "whitespace-nowrap text-muted-foreground", children: lt(v.created_at) })
        ] }, v.id);
    ...
    t.totalFeedback > 0 && /* @__PURE__ */ e.jsx(Pe, { className: "grow-0", children: /* @__PURE__ */ e.jsxs("div", { className: "flex w-full items-center justify-between gap-3", children: [
      /* @__PURE__ */ e.jsxs(V, { variant: "outline", onClick: () => {
        const v = `(feedback.post_id:'${s}'+feedback.score:1)`, h = `(feedback.post_id:'${s}'+feedback.score:0)`, L = `${encodeURIComponent(v)}&post=${s}`, P = `${encodeURIComponent(h)}&post=${s}`;
  ...
  const { data: s, isLoading: a } = je(t), { data: r, isLoading: i } = je(t, {
    ...
    var b, C, y, _, w, S;
    return n ? {
      sent: ((b = n.email) == null ? void 0 : b.email_count) || 0,
    ...
    const b = o.count.positive_feedback || 0, C = o.count.negative_feedback || 0, y = b + C;
    return {
      positiveFeedback: b,
      negativeFeedback: C,
      totalFeedback: y
    ...
    var b;
    return (b = n == null ? void 0 : n.newsletter) == null ? void 0 : b.id;
  }, [n]), { data: c, isLoading: x } = Et({
    searchParams: m ? { newsletter_id: m } : {},
    enabled: !!m
  }), g = j(() => c != null && c.stats ? c.stats.map((b) => b.post_id) : [], [c]), { data: k, isLoading: p } = Tt({
    ...
    if (!(c != null && c.stats))
      return;
    const b = c.stats, C = (k == null ? void 0 : k.stats) || [], y = /* @__PURE__ */ new Map();
    C.forEach((w) => {
      y.set(w.post_id, w);
    });
    const _ = b.map((w) => {
  ...
  }, [c, k]), v = x || p, { data: h, isLoading: L, refetch: P } = Bt({
    searchParams: {
      filter: `post_id:'${t}'`
    }
  }), I = j(() => {
    ...
    const C = b.reduce((_, w) => _ + (w.open_rate || 0), 0), y = b.reduce((_, w) => _ + (w.click_rate || 0), 0);
    return {
      openRate: Number((C / b.length).toFixed(2)),
      clickRate: Number((y / b.length).toFixed(2))
    };
  }, [f]), G = j(() => Mt(h), [h]), K = j(() => ({
...
}, Ne = () => /* @__PURE__ */ e.jsx("div", { className: "absolute -right-4 top-1/2 z-10 hidden size-8 -translate-y-1/2 items-center justify-center rounded-full border bg-background text-muted-foreground   md:!visible md:!flex", children: /* @__PURE__ */ e.jsx(Vt, { className: "ml-0.5", size: 16, strokeWidth: 1.5 }) }), we = ({
  dataColor: t,
  value: s,
  avgValue: a
  ...
  const t = Ce(), [s, a] = $(null), [r, i] = $(""), n = ae(null), o = ae(null), l = 10, { chartSize: u } = ms(), { appSettings: m } = ct(), { emailTrackClicks: c, emailTrackOpens: x } = (m == null ? void 0 : m.analytics) || {}, { post: g, isPostLoading: k, postId: p } = Dt(), f = g, v = xt(f);
  D(() => {
    !k && !v && t(`/posts/analytics/${p}`);
  }, [t, p, k, v]);
  const { stats: h, averageStats: L, topLinks: P, isLoading: I, refetchTopLinks: G } = us(p), { editLinks: K } = ds(), b = j(() => {
    if (!(f != null && f.count))
      return {
        positiveFeedback: 0,
        negativeFeedback: 0,
  ...
  }, [f]), y = j(() => b.totalFeedback > 0 ? !0 : C, [b.totalFeedback, C]), _ = (d) => {
    const N = te(P, d);
    N && (a(d), i(N.link.to));
  }, w = () => {
    if (!s)
  ...
  const Y = I || k, Ke = [
    ...
    { datatype: "Average", value: L.openedRate, fill: "url(#gradientGray)", color: "hsl(var(--chart-gray))" },
    { datatype: "This newsletter", value: h.openedRate, fill: "url(#gradientBlue)", color: "hsl(var(--chart-blue))" }
  ], Ze = {
    percentage: {
      label: "Opened"
    },
    ...
    { datatype: "Average", value: L.clickedRate, fill: "url(#gradientGray)", color: "hsl(var(--chart-gray))" },
    { datatype: "This newsletter", value: h.clickedRate, fill: "url(#gradientTeal)", color: "hsl(var(--chart-teal))" }
  ], Qe = {
    percentage: {
      label: "Clicked"
    },
  ...
  let z = "grid-cols-3", B = "aspect-[16/10] w-full max-w-[320px] sm:aspect-[2/1] md:aspect-[10/14] md:max-w-none lg:aspect-square";
  return (!c || !x) && (z = "grid-cols-2", B = "aspect-[16/10] w-full max-w-[320px] sm:aspect-[2/1] md:aspect-square md:max-w-none lg:aspect-[15/10]"), !c && !x && (z = "grid-cols-1", B = "aspect-square w-full sm:aspect-[16/10] md:max-w-[320px] md:max-h-[320px] lg:aspect-[12/10]"), /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
    ...
    /* @__PURE__ */ e.jsx(ht, { children: /* @__PURE__ */ e.jsxs("div", { className: `grid grid-cols-1 gap-6 ${y && c && "lg:grid-cols-2"}`, children: [
      ...
      y && /* @__PURE__ */ e.jsx(cs, { feedbackStats: b }),
...
//# sourceMappingURL=newsletter-6Y-pMOSy.mjs.map
