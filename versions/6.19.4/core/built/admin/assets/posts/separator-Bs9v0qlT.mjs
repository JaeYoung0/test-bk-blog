import { c as N, g as b } from "./heading-eNl0HQ4y.mjs";
import { D as u, E as P, F as p, G as d, j as f, H as h, J as _, n as O } from "./index-Cr7pONoj.mjs";
...
function A(t) {
  const n = /* @__PURE__ */ C(t), e = u((o, r) => {
    ...
    const a = p.toArray(i), l = a.find(T);
    if (l) {
      const c = l.props.children, x = a.map((m) => m === l ? p.count(c) > 1 ? p.only(null) : d(c) ? c.props.children : null : m);
      return /* @__PURE__ */ f.jsx(n, { ...s, ref: r, children: d(c) ? h(c, void 0, x) : null });
    }
...
function C(t) {
  const n = u((e, o) => {
    ...
    if (S(r) && typeof y == "function" && (r = y(r._payload)), d(r)) {
      ...
      return r.type !== _ && (a.ref = o ? N(o, s) : s), h(r, a);
    }
    return p.count(r) > 1 ? p.only(null) : null;
  });
...
}, {}), z = "Separator", v = "horizontal", D = ["horizontal", "vertical"], E = u((t, n) => {
...
//# sourceMappingURL=separator-Bs9v0qlT.mjs.map
