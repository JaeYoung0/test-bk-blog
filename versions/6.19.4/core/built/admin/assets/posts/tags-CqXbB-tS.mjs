import { D as h, j as e, R as g, T as J, n as w, A as K, B as W, Z as S, q as X, e as Y, _ as ee } from "./index-Cr7pONoj.mjs";
import { b as G, P as T, f as se, d as ae, B as b } from "./heading-eNl0HQ4y.mjs";
import { c as E, I as te, u as re, R as le } from "./skeleton-nGxKIBIH.mjs";
import { H as m, u as oe } from "./use-infinite-virtual-scroll-DN7vL_a2.mjs";
import { M as ne } from "./main-layout-BqiEnIE5.mjs";
import { T as ie, a as ce, b as P, c as j, d as de, e as f } from "./table-tG8dmQHx.mjs";
import { P as ue } from "./pencil-CuqEDKBG.mjs";
import { E as ge } from "./empty-indicator-Bu5ew_PQ.mjs";
import { L as pe } from "./loading-indicator-PS-AyPMj.mjs";
import { d as xe } from "./hooks-CBG95Unn.mjs";
import { T as me } from "./tags-CcbbZKAW.mjs";
var $ = "Toggle", C = h((s, t) => {
...
C.displayName = $;
var M = C, x = "ToggleGroup", [V] = ae(x, [
  E
]), L = E(), _ = g.forwardRef((s, t) => {
  const { type: r, ...a } = s;
  if (r === "single") {
    const l = a;
...
_.displayName = x;
var [B, D] = V(x), fe = g.forwardRef((s, t) => {
  const {
    value: r,
    defaultValue: a,
    onValueChange: l = () => {
...
be.displayName = M.displayName;
const U = K({
  size: "default",
  variant: "default"
}), Z = h(({ className: s, variant: t, size: r, children: a, ...l }, o) => /* @__PURE__ */ e.jsx(
  q,
  {
    ref: o,
...
const Ne = ({ children: s, className: t, ...r }) => /* @__PURE__ */ e.jsx("section", { className: w("flex gap-6 flex-col p-4 lg:p-8 size-full grow", t), ...r, children: s }), we = ({ currentTab: s }) => /* @__PURE__ */ e.jsxs(m, { variant: "inline-nav", children: [
  ...
  /* @__PURE__ */ e.jsxs(m.Actions, { children: [
    /* @__PURE__ */ e.jsx(m.ActionGroup, { children: /* @__PURE__ */ e.jsxs(Z, { "data-testid": "tags-header-tabs", size: "button", type: "single", value: s, children: [
...
] }), Te = ({ children: s }) => /* @__PURE__ */ e.jsx(ne, { children: /* @__PURE__ */ e.jsx("div", { className: "grid w-full grow", children: /* @__PURE__ */ e.jsx("div", { className: "flex h-full flex-col", "data-testid": "tags-page", children: s }) }) }), A = ({ height: s }) => /* @__PURE__ */ e.jsx("tr", { "aria-hidden": "true", className: "flex lg:table-row", children: /* @__PURE__ */ e.jsx("td", { className: "flex lg:table-cell", style: { height: s } }) }), Pe = h(function(t, r) {
  return /* @__PURE__ */ e.jsx(
    P,
    {
      ref: r,
...
function ye({
  ...
  const o = X(null), { visibleItems: n, spaceBefore: i, spaceAfter: d } = oe({
    items: s,
    totalItems: t,
    hasNextPage: r,
    isFetchingNextPage: a,
  ...
  return /* @__PURE__ */ e.jsx("div", { ref: o, className: "overflow-hidden", children: /* @__PURE__ */ e.jsxs(
    ie,
    {
      ...
      children: [
        /* @__PURE__ */ e.jsx(ce, { className: "hidden lg:!visible lg:!table-header-group", children: /* @__PURE__ */ e.jsxs(P, { children: [
        ...
        /* @__PURE__ */ e.jsxs(de, { className: "flex flex-col lg:table-row-group", children: [
                ...
                children: [
                  ...
                  /* @__PURE__ */ e.jsx(f, { className: "col-start-1 col-end-1 row-start-3 row-end-3 flex p-0 md:col-start-2 md:col-end-2 md:row-start-1 md:row-end-3 lg:table-cell lg:p-4", children: (I = c.count) != null && I.posts ? /* @__PURE__ */ e.jsx(
                    "a",
                    {
                      ...
                      children: `${Y((R = c.count) == null ? void 0 : R.posts)}  ${((k = c.count) == null ? void 0 : k.posts) === 1 ? "post" : "posts"}`
                    }
          ...
          /* @__PURE__ */ e.jsx(A, { height: d })
        ] })
      ]
    }
  ) });
}
const Ge = "TagsResponseType", Ce = xe({
  dataType: Ge,
  path: "/tags/",
  ...
  return /* @__PURE__ */ e.jsxs(Te, { children: [
    ...
    /* @__PURE__ */ e.jsx(Ne, { children: o ? /* @__PURE__ */ e.jsx("div", { className: "flex h-full items-center justify-center", children: /* @__PURE__ */ e.jsx(pe, { size: "lg" }) }) : l ? /* @__PURE__ */ e.jsxs("div", { className: "mb-16 flex h-full flex-col items-center justify-center", children: [
...
//# sourceMappingURL=tags-CqXbB-tS.mjs.map
