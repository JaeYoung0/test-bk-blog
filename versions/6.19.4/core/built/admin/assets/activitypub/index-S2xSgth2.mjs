import { a6 as E, j as t, aO as H, R as u, d as C, aP as O, c as g, e as L, av as D, aw as V, L as q, E as G, f as Q, aQ as K, S as w, A as $, B as Z, aR as J, aa as P, h as b, r as X, ac as U, aS as Y, aT as ee, k as te, P as se } from "./index-CVWyRkqY.mjs";
import { A as ae } from "./at-sign-CuLWrVPP.mjs";
import { R as ne } from "./reply-DzWfm42d.mjs";
/**
...
const fe = ({ group: a }) => {
  ...
  }, n = 5, { data: i, error: o, fetchNextPage: x, hasNextPage: h, isFetchingNextPage: p, isLoading: y } = O("index"), k = (i == null ? void 0 : i.pages.flatMap((e) => ye(e.notifications))) ?? Array(10).fill({ actors: [{}] }), j = g(null), v = g(null);
  ...
  return o && D(o) ? /* @__PURE__ */ t.jsx(V, { errorCode: o.code, statusCode: o.statusCode }) : /* @__PURE__ */ t.jsx(q, { children: /* @__PURE__ */ t.jsxs("div", { className: "z-0 flex w-full flex-col items-center", children: [
...
//# sourceMappingURL=index-S2xSgth2.mjs.map
