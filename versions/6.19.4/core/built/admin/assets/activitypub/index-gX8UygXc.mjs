import { a6 as Xn, R as Q, j as n, s as In, b as y, e as L, ba as Pn, bb as Fn, B as $, bE as ne, bc as Ln, bF as ee, c as U, bG as te, W as jn, d as Rn, bH as un, S as N, P as ae, A as oe, h as re, g as zn, r as ie, aa as de, aT as se, k as hn, F as sn, i as cn, bI as ce, ab as le, a as ge, u as pe, l as ue, L as he, D as me, n as ke, o as fe, p as be, bJ as xe, bK as ve, bL as ye, av as Cn, aw as we } from "./index-CVWyRkqY.mjs";
import { u as je, D as ze, A as Ce, S as Sn } from "./deleted-feed-item-Db5FmgLL.mjs";
import { T as Se } from "./topic-filter-CIbuTKE8.mjs";
import { S as _e } from "./separator-LJZrmf1k.mjs";
import { I as _n } from "./inbox-BRa0al8u.mjs";
/**
 ...
 */
const Ee = [["path", { d: "M5 12h14", key: "1ays0h" }]], Ne = Xn("minus", Ee), On = Q.forwardRef(({ children: a, className: r, ...t }, i) => /* @__PURE__ */ n.jsx(
  "div",
  {
    ref: i,
...
On.displayName = "EmptyBadge";
const mn = Q.forwardRef(({ children: a, className: r, title: t, description: i, actions: d, ...u }, s) => /* @__PURE__ */ n.jsxs("div", { ref: s, className: In("flex flex-col items-center justify-center space-y-3 text-center", r), ...u, children: [
  /* @__PURE__ */ n.jsx(On, { children: a }),
...
const kn = ["1.5rem", "1.6rem", "1.7rem", "1.8rem", "2rem"], Y = {
  ...
  }), [d, u] = y(() => localStorage.getItem(Y.FONT_STYLE) || "sans"), s = (o) => {
  ...
  const [u, s] = y(null), h = Q.useRef(!1), v = (p) => {
    if (!(r != null && r.contentDocument))
      return;
    const o = r.contentDocument.getElementById(p);
    o && t.current && (h.current = !0, s(p), t.current.scrollTo({
      top: o.offsetTop - 20,
      behavior: "smooth"
    }), setTimeout(() => {
      h.current = !1;
  ...
  return L(() => {
    ...
    const o = () => {
      ...
      if (!l)
        return;
      const I = p.scrollTop, R = 100, B = a.map((C) => l.getElementById(C.id)).filter((C) => C !== null).map((C) => ({
        id: C.id,
        top: C.offsetTop
      }));
      if (!B.length)
        return;
      const _ = B.reduce((C, A) => A.top - R <= I ? A : C);
  ...
  2: "pl-6",
  3: "pl-10"
}, Oe = ({ items: a, activeHeading: r, onItemClick: t, onOpenChange: i }) => {
  const [d, u] = y(!1), s = Q.useRef();
  if (Q.useEffect(() => () => {
...
`, st = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: dt
}, Symbol.toStringTag, { value: "Module" })), ct = `.kg-header-card,
.kg-header-card * {
    box-sizing: border-box;
}
...
`, vt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: xt
}, Symbol.toStringTag, { value: "Module" })), yt = `.kg-transistor-card {
    display: flex;
    justify-content: center;
}
...
`, wt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: yt
}, Symbol.toStringTag, { value: "Module" })), jt = `.kg-video-card,
.kg-video-card * {
    box-sizing: border-box;
}
...
`, zt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: jt
}, Symbol.toStringTag, { value: "Module" })), Ct = /* @__PURE__ */ Object.assign({ "../../ghost/core/core/frontend/src/cards/js/audio.js": Ae, "../../ghost/core/core/frontend/src/cards/js/gallery.js": De, "../../ghost/core/core/frontend/src/cards/js/toggle.js": qe, "../../ghost/core/core/frontend/src/cards/js/video.js": Ue }), St = /* @__PURE__ */ Object.assign({ "../../ghost/core/core/frontend/src/cards/css/audio.css": Ke, "../../ghost/core/core/frontend/src/cards/css/blockquote.css": Ye, "../../ghost/core/core/frontend/src/cards/css/bookmark.css": Ze, "../../ghost/core/core/frontend/src/cards/css/button.css": Ge, "../../ghost/core/core/frontend/src/cards/css/callout.css": nt, "../../ghost/core/core/frontend/src/cards/css/collection.css": tt, "../../ghost/core/core/frontend/src/cards/css/cta.css": ot, "../../ghost/core/core/frontend/src/cards/css/file.css": it, "../../ghost/core/core/frontend/src/cards/css/gallery.css": st, "../../ghost/core/core/frontend/src/cards/css/header.css": lt, "../../ghost/core/core/frontend/src/cards/css/header_v2.css": pt, "../../ghost/core/core/frontend/src/cards/css/nft.css": ht, "../../ghost/core/core/frontend/src/cards/css/product.css": kt, "../../ghost/core/core/frontend/src/cards/css/signup.css": bt, "../../ghost/core/core/frontend/src/cards/css/toggle.css": vt, "../../ghost/core/core/frontend/src/cards/css/transistor.css": wt, "../../ghost/core/core/frontend/src/cards/css/video.css": zt }), _t = Object.values(Ct).map((a) => a.default).join(`

`), Et = Object.values(St).map((a) => a.default).join(`
...
`), Nt = ({
  ...
  const I = U(null), [R, B] = y(!0), [_, C] = y("0px"), A = document.documentElement.classList.contains("dark") && s === "SYSTEM" || s === "DARK", Z = Te(), f = `
  ...
  return L(() => {
    ...
    const O = (b) => {
      if (b.data.type === "resize") {
        ...
        C(S), g.style.height = S, b.data.isLoaded && B(!1);
      }
    }, j = (b) => {
      if (b.key === "Escape") {
...
}, Nn = () => /* @__PURE__ */ n.jsx("div", { className: "h-px bg-black/[8%] dark:bg-gray-950" }), X = /* @__PURE__ */ new Map(), It = ({
  postId: a = null,
  onClose: r
}) => {
  var xn, vn, yn;
  const {
    ...
    decreaseFontSize: p,
    resetFontSize: o
  } = Ie(), c = U(null), [l, I] = y(!1), [R, B] = y(!1), [_, C] = y(/* @__PURE__ */ new Set()), [A, Z] = y(/* @__PURE__ */ new Set()), [f, g] = y(/* @__PURE__ */ new Set()), [O, j] = y(!1), E = U(null), b = U(null), {
    post: S,
    processedReplies: nn,
    isLoading: T,
    loadMoreChildren: ln,
  ...
  } = je(a ?? "", { includeAncestors: !1 }), q = S, m = q == null ? void 0 : q.object, H = q == null ? void 0 : q.actor, Tn = (vn = (xn = q == null ? void 0 : q.object) == null ? void 0 : xn.metadata) == null ? void 0 : vn.ghostAuthors, Mn = (m == null ? void 0 : m.replyCount) ?? 0;
  L(() => {
    if (!tn)
      return;
  ...
  function An(e) {
    C((w) => {
      const k = new Set(w);
      return k.has(e) ? k.delete(e) : (k.add(e), Z((z) => {
        const M = new Set(z);
        return M.add(e), M;
      })), k;
    });
  ...
  return L(() => {
  ...
  }, [J, T, a]), T ? /* @__PURE__ */ n.jsx("div", { className: `max-h-full overflow-auto rounded-md ${t === "DARK" && "dark"} ${(t === "LIGHT" || t === "SEPIA") && "light"} ${F[t].background}`, children: /* @__PURE__ */ n.jsx("div", { className: "flex h-full flex-col", children: /* @__PURE__ */ n.jsxs("div", { className: "relative flex-1", children: [
  ...
  ] }) }) }) : S ? /* @__PURE__ */ n.jsx("div", { ref: c, className: `max-h-full overflow-auto rounded-md ${t === "DARK" && "dark"} ${(t === "LIGHT" || t === "SEPIA") && "light"} ${F[t].background}`, "data-scrollable-container": !0, children: /* @__PURE__ */ n.jsx(n.Fragment, { children: /* @__PURE__ */ n.jsxs("div", { className: "flex h-full flex-col", children: [
    /* @__PURE__ */ n.jsxs("div", { className: "relative flex-1", children: [
            ...
            /* @__PURE__ */ n.jsxs("div", { className: "col-[2/3] mx-auto flex w-full items-center justify-between gap-3 max-md:hidden", children: [
              /* @__PURE__ */ n.jsx(ae, { actor: H, isCurrentUser: m.authored, children: /* @__PURE__ */ n.jsxs("div", { className: "flex cursor-pointer items-center gap-3", children: [
                ...
                /* @__PURE__ */ n.jsxs("div", { className: "relative z-10 mt-0.5 flex min-w-0 cursor-pointer flex-col overflow-visible text-[1.5rem]", onClick: (e) => re(H, rn, e), children: [
                  /* @__PURE__ */ n.jsx("div", { className: "flex w-full", children: /* @__PURE__ */ n.jsx("span", { className: "min-w-0 truncate whitespace-nowrap font-semibold text-black hover:underline dark:text-white", children: T ? /* @__PURE__ */ n.jsx(N, { className: "w-20" }) : H.name }) }),
                  /* @__PURE__ */ n.jsxs("div", { className: "flex w-full", children: [
                    !T && /* @__PURE__ */ n.jsx("span", { className: 'truncate text-gray-700 after:mx-1 after:font-normal after:text-gray-700 after:content-["·"]', children: zn(H) }),
                    /* @__PURE__ */ n.jsx("span", { className: "text-gray-700", children: T ? /* @__PURE__ */ n.jsx(N, { className: "w-[120px]" }) : ie(m, !m.authored) })
                  ] })
                ] })
              ] }) }),
      ...
      /* @__PURE__ */ n.jsxs("div", { className: "relative flex-1", children: [
        ...
        !T && /* @__PURE__ */ n.jsx("div", { className: "grow overflow-y-auto", children: /* @__PURE__ */ n.jsxs("div", { className: "mx-auto px-6 pb-10 pt-5", style: { maxWidth: qn }, children: [
          ...
          m.type === "Tombstone" && /* @__PURE__ */ n.jsx(ze, { last: !0 }),
          ...
          T && /* @__PURE__ */ n.jsx(hn, { size: "lg" }),
          /* @__PURE__ */ n.jsxs("div", { ref: Bn, className: "mx-auto w-full", style: { maxWidth: W }, children: [
            nn.map((e, w) => {
              const k = w === nn.length - 1, z = e.mainReply.id, M = _.has(z), V = A.has(z), G = f.has(z), D = e.chain.length > 0;
            ...
            O && /* @__PURE__ */ n.jsx("div", { className: "flex flex-col items-center justify-center text-center", children: /* @__PURE__ */ n.jsx(hn, { size: "md" }) })
          ] }),
    ...
    !T && /* @__PURE__ */ n.jsxs("div", { className: "pointer-events-none !visible sticky bottom-0 hidden items-end justify-between px-10 pb-[42px] lg:!flex", children: [
      /* @__PURE__ */ n.jsx("div", { className: "pointer-events-auto text-gray-600", children: ce(m.content ?? "") }),
  ...
  const h = Rn(), { canGoBack: v, goBack: p } = ge(), [o, c] = y(!1), l = pe(), { topicsQuery: I } = ue(), { data: R } = I, B = R && R.topics.length > 0;
  L(() => {
    c(!!l.postId);
  }, [l.postId]);
  const _ = U(null), C = U(null), A = U(null);
  ...
  return /* @__PURE__ */ n.jsxs(he, { children: [
    B && /* @__PURE__ */ n.jsx(Se, { currentTopic: t, excludeTopics: ["top"], onTopicChange: s }),
        ...
        r.map((f, g) => /* @__PURE__ */ n.jsxs(
          "li",
          {
            ...
            children: [
              ...
              g === Z && /* @__PURE__ */ n.jsx("div", { ref: C, className: "h-1" })
            ]
          },
          `${f.id}-${f.type}-${g}`
        )),
    ...
    /* @__PURE__ */ n.jsx(
      me,
      {
        ...
        children: /* @__PURE__ */ n.jsxs(ke, { className: "inset-y-3 h-[calc(100vh-24px)] w-screen max-w-[calc(100vw-24px)] !animate-none p-0 focus:outline-none dark:bg-gray-950", children: [
          ...
          l.postId && /* @__PURE__ */ n.jsx(It, { postId: l.postId, onClose: () => {
            v ? p() : h("/reader");
          } })
        ] })
      }
  ...
  const [a, r] = y("following"), { inboxQuery: t } = ve({ enabled: a === "following" }), { discoveryFeedQuery: i } = ye({ enabled: a !== "following", topic: a }), d = a === "following" ? t : i, { data: u, error: s, fetchNextPage: h, hasNextPage: v, isFetchingNextPage: p, isLoading: o } = d, c = s && Cn(s) && s.statusCode === 404 && a !== "following";
  if (s && Cn(s) && !c)
    return /* @__PURE__ */ n.jsx(we, { errorCode: s.code, statusCode: s.statusCode });
...
//# sourceMappingURL=index-gX8UygXc.mjs.map
